...
object DecisionTreeRunner {
  ...
  def run(params: Params) {
    ...
    println("Features " + examples.map(y => y.features))
    ...
    println("Top node: " + model.topNode.toString())
    println("left node: "  + model.topNode.leftNode.get.leftNode.get.leftNode.get.leftNode.toString())
    println("right node: " + model.topNode.rightNode.get.leftNode.toString())
